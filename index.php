...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <!-- Akses Guru -->
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link"><i class="nav-icon fas fa-chalkboard-teacher"></i><p>Akses Guru<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="#" class="nav-link"><p>Profil</p></a></li>
              <li class="nav-item"><a href="#" class="nav-link"><p>Kelas</p></a></li>
              <li class="nav-item"><a href="#" class="nav-link"><p>Jadwal</p></a></li>
            </ul>
          </li>
          <!-- Akses Siswa -->
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link"><i class="nav-icon fas fa-user-graduate"></i><p>Akses Siswa<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="#" class="nav-link"><p>Profil</p></a></li>
              <li class="nav-item"><a href="#" class="nav-link"><p>Jadwal</p></a></li>
            </ul>
          ...
          <!-- Database Export -->
          <li class="nav-item">
            <a href="http://localhost/phpmyadmin/index.php?route=/export" target="_blank" class="nav-link">
  ...
  <div class="content-wrapper">
    <section class="content-header"><div class="container-fluid"><h1>Starter Page</h1></div></section>
    <section class="content">
      <div class="card">
        <div class="card-header"><h3 class="card-title">Dashboard</h3></div>
        <div class="card-body">Selamat Datang di Sistem Jadwal Guru pada SMA/SMK XYZ</div>
      </div>
    </section>
  </div>
